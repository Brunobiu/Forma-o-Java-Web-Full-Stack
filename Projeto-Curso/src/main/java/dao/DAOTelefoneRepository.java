...
public class DAOTelefoneRepository {
	...
	//Carregar as LISTA de telefones dos usuarios
	...
	//Metodo que  grava os telefones no  banco de dados.
	...
	//Não aceitando numeros duplicados
	public boolean existeFone(String fone, Long idUser) throws Exception {
		...
		return resuSet.getBoolean("existe");
