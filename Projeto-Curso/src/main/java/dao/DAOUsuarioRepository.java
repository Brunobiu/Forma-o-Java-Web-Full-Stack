...
public class DAOUsuarioRepository {
	...
	public ModelLogin gravarUsuario(ModelLogin objeto, Long userLogado ) throws Exception{
		...
		if (objeto.isNovo()) { 
			...
			connection.commit();
				...
				//Se é usuario novo vai inserir a foto @@@@@@@@@@@@@
		...
		//UPDATE Grava um novo
			...
			//Se não é usuario novo atualizar a foto @@@@@@@@@@@@@
			if (objeto.getFotouser() != null && !objeto.getFotouser().isEmpty()) {
	...
	public List<ModelLogin> consultaUsuarioListPaginado(Long userLogado, Integer offset) throws Exception{
		...
		while (resultado.next()) { //Percorreras linhas de resultado do SQL
	...
	//Metodo que manda somente 5 por pagina
	public int totoalPagina(Long userLogado) throws Exception{
	...
	//Metodo que retorna todos os usuarios no modal externo
	...
	// Consulta usuario e tras uma lista, modal na tela
	...
	//Consulta pelo ServletGenericUtil
	...
	//Consultar no banco de dados pelo loguin
	...
	//Consultar no banco de dados pelo usuarioLogado
	...
	// Carregando os dados do usuario, pra fazer o metodo do telefone
	...
	// Consultando se exixte login repitido	
	public boolean validaLogin (String login) throws Exception {
		...
		resultado.next(); // Tem que dar next pra ele entrar nos resultados
