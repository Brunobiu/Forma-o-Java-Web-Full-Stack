														...
														<form class="form-material" enctype="multipart/form-data" action="<%= request.getContextPath() %>/ServletUsuarioControler" method="post" id="formUser">
                                                            ...
                                                            <div class="form-group form-default input-group mb-4">
                                                            	...
                                                            	<c:if test="${modolLogin.fotouser != '' && modolLogin.fotouser != null}">
                                                            		<a href="<%= request.getContextPath()%>/ServletUsuarioControler?acao=downloadFoto&id=${modolLogin.id}">
                                                            ...
                                                            <div class="form-group form-default form-static-label">
                                                                <input onabort="pesquisaCep();" type="text" name="cep" id="cep" class="form-control" required="required" autocomplete="off" value="${modolLogin.cep}">
                                                                <span class="form-bar"></span>
                                                          ...
                                                          <button type="button" class="btn btn-primary waves-effect waves-light" onclick="limparForm();">Novo</button>
												            ...
												            <button type="button" class="btn btn-info waves-effect waves-light" onclick="criarDeletarComAjax();">Excluir</button>
												...
												<tbody>
													<c:forEach items='${modelLogins}' var="ml">
														<tr>
															...
															<td> <a class="btn btn-success" href="<%= request.getContextPath()%>/ServletUsuarioControler?acao=buscarEditar&id=${ml.id}" >Ver</a> </td>
														</tr>
													</c:forEach>
...
<!-- Tela de modal com bootstrap 4 pesquisar -->
<div class="modal fade" id="exampleModalUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Pesquisa de usúario</h5>
...
<!-- Limpando o Formulario de cadastro -->	
function limparForm() {
