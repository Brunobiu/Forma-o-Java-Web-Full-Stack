												...
												<div class="card">
													...
													<div class="card-block">
														...
														<form class="form-material"
															...
															<input type="hidden" id="acaoRelatorioImprimirTipo" name="acao" value="imprimirRelarorioUser">
															...
															<div class="form-row align-items-center">
																...
																<div class="col-auto my-1">
																	<button type="button" onclick="imprimirHtml();" class="btn btn-primary">Mostrar Relatório</button>
																...
																<tbody>
																	<c:forEach items="${listaUser}" var="ml">
																		...
																		<c:forEach items="${ml.telefones}" var="fone">
																			<tr>
																			 <td/>
																			 	<td style="font-size: 10px; color: red" ><c:out value="${fone.numero}"></c:out></td>
																			</tr>
																		</c:forEach>
...
function imprimirHtml() {
	document.getElementById("acaoRelatorioImprimirTipo").value = 'imprimirRelarorioUser';
	$("#formUser").submit();
}

function imprimirPdf() {
	document.getElementById("acaoRelatorioImprimirTipo").value = 'imprimirRelarorioPDF';
	$("#formUser").submit();
	return false;
}

function imprimirExcel() {
	document.getElementById("acaoRelatorioImprimirTipo").value = 'imprimirRelarorioExcel';
	$("#formUser").submit();
	return false;
}
